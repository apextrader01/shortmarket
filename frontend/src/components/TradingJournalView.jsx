...
export default function TradingJournalView({ onOpenPaperTrading, onBack }) {
    ...
    <div style={{
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              <button
                ...
                onClick={() => {
                  if (item.isBridge) {
                    // Seamlessly launch the live Paper Trading terminal!
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ══════════════════════════════════════════════════════════════ */}
          {/* 1. DASHBOARD VIEW (Matching Exact UI from Screenshot)           */}
          {/* ══════════════════════════════════════════════════════════════ */}
          {activeTab === 'DASHBOARD' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '1400px', margin: '0 auto' }}>
              ...
              {/* 4 KPI METRIC CARDS (Exact Match to Screenshot) */}
              <div style={{
                display: 'grid',
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '26px', fontWeight: '800', color: '#38bdf8', margin: '6px 0 2px 0' }}>
                      {metrics.winRate}%
                    </div>
                    <div style={{ fontSize: '11px', color: '#64748b' }}>
                      0% vs last 30 days
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '26px', fontWeight: '800', color: '#a855f7', margin: '6px 0 2px 0' }}>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '26px', fontWeight: '800', color: '#f97316', margin: '6px 0 2px 0' }}>
                      {metrics.tradesCount}
                    </div>
                    <div style={{ fontSize: '11px', color: '#64748b' }}>
                      0 vs last 30 days
              ...
              {/* CONFIDENCE INDEX CARD (Matching Screenshot) */}
              <div style={{
                backgroundColor: '#131d31',
                border: '1px solid #1e293b',
                borderRadius: '12px',
              ...
              {/* BOTTOM ROW: CUMULATIVE P&L (Left 65%) & TOP TRADES (Right 35%) */}
              <div style={{
                display: 'grid',
                      ...
                      {['D', 'W', 'M'].map((p) => (
                        <button
                          ...
                          style={{
                            ...
                            color: pnlPeriod === p ? '#ffffff' : '#64748b',
                            cursor: 'pointer'
                          }}
                        >
                          {p}
                  ...
                  {allTrades.length === 0 ? (
                    <div style={{
                      ...
                      <div style={{ fontSize: '12px', color: '#64748b', maxWidth: '300px' }}>
                        Your equity curve will appear here once you start logging trades.
                      </div>
                      <button
                        onClick={() => setShowNewTradeModal(true)}
                        style={{
                ...
                <div style={{
                  ...
                  {/* Empty State or Top Trades List */}
                  {metrics.topTrades.length === 0 ? (
                    <div style={{
                      ...
                      <div style={{ fontSize: '12px', color: '#64748b' }}>
                        Start trading to see your best performers
                      </div>
                    </div>
                  ) : (
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: '11px', color: '#64748b', marginTop: '2px' }}>
                          Category: {rule.category} • Adherence: {Math.round(((rule.followed || 10) / ((rule.followed || 10) + (rule.broken || 1))) * 100)}%
                        </div>
                      </div>
                    </div>
                ...
                {mistakes.map((m) => (
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <div style={{ fontSize: '10px', color: '#64748b' }}>
                        Occurred {m.count || m.frequency || 1} times
                      </div>
                    </div>
                  </div>
                ))}
          ...
          {/* ══════════════════════════════════════════════════════════════ */}
          {/* 7. OTHER SUB-VIEWS (AI, Reports, Risk, Community, etc.)        */}
          {/* ══════════════════════════════════════════════════════════════ */}
            ...
            <form onSubmit={handleSaveNewTrade} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '10px' }}>
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g. NIFTY 24500 CE or RELIANCE"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Why did you take this trade? Any lessons?"
                  style={{
                    width: '100%',
                    backgroundColor: '#131d31',
                    border: '1px solid #1e293b',
